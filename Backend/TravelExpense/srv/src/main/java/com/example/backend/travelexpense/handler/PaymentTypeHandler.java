...
public class PaymentTypeHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public PaymentTypeHandler(com.example.backend.travelexpense.MainServlet servlet, com.example.backend.travelexpense.proxy.TravelexpenseService service) {
